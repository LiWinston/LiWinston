  ...
  <tbody>
    <tr>
      <td colspan="2" align="center">
        由于知识产权等原因，这些项目的源代码未公开。部分为实习/客户项目。<br>
        <sub>对闭源项目源码感兴趣者敬请私聊。</sub>
      </td>
    </tr>
    <tr>
      <td width="30%" align="center"><b>🔮 HuskyAI Cognitive Lens</b></td>
      <td>
        <b>全栈式实时认知增强与智能辅助系统。</b><br>
        • <b>隐形视觉</b>: 独创 <b>DirectX 穿透级透明覆盖层</b>，实现<b>录屏不可见</b>的物理级隐匿；集成 <b>YOLOv11</b> 视觉工厂，毫秒级捕获与解析屏幕信息流。<br>
        • <b>全知大脑</b>: 内置 <b>工业级 RAG 引擎</b>，采用 <b>知识图谱驱动</b>、<b>Contextualized Chunking</b> 与 <b>高斯平滑向量注入</b> 的混排技术，构建"滴水不漏"的领域知识库。<br>
        • <b>影子协同</b>: 支持 <b>实时语音流语义分析</b>、<b>拟人化自动输入</b> 及 <b>跨设备远程控制</b>，提供全方位的沉浸式人机协同体验。<br>
        • <b>定位</b>: 面向高时效性信息检索与决策辅助场景的<b>实时认知增强</b>解决方案。
      </td>
    </tr>
    <tr>
